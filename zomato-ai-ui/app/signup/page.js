        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                    ...
                    />
                    <h2 style={{ fontSize: '24px', fontWeight: 600, color: '#1c1c1c' }}>Create Account</h2>
                </div>
                ...
                <p style={{ textAlign: 'center', marginTop: '24px', fontSize: '14px', color: '#666' }}>
                    Already have an account? <Link href="/login" style={{ color: '#cb202d', fontWeight: 600 }}>Log in</Link>
                </p>
            </div>
        </div>
    );
